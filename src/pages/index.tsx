  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless legal processes with HR Law - Your trusted partner for automatically filling out small claims court forms."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1593115057322-e94b77572f20?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjb3VydHxlbnwwfHx8fDE2OTEyNTk4Nzh8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless legal processes with HR Law - Your trusted partner for automatically filling out small claims court forms.`}
            </Text>
            <Box
